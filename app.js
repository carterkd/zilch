(function () {
  ...
  const TUTORIAL_STEPS = [
    ...
    },
    {
      ...
      copy:
        "Three 1s score 1,000. Three 2s through 6s score face value times 100. Four of any non-1 number scores 1,000; five to ten of any number score 2,000 up to 7,000.",
      dice: [5, 5, 5, 2, 2, 2],
      stats: [
        ["Four 1s", "1,100"],
        ["Three 5s", "500"],
